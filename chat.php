...
function print_stylesheet($init=false){
	...
	echo 'a:visited{text-decoration: none;color:#B33CB4;} a:active{text-decoration: none;color:#FF0033;} a:link{text-decoration: none;color:#0000FF;} #messages{word-wrap:break-word;} ';
